...
/* 			$(".hire_date_year_start").val("1980").prop("selected", true);
	...
	function flatpickr(){
		...
		// flatpicker 입사일 검색 마지막일
		$("[name='hire_date_end']").flatpickr({
			dateFormat: "Y-m-d"
			,minDate: "1980-01"
			,maxDate: "today"
			,defaultDate : "today"	
...
<%-- 			<tr>
			...
			<tr>
				<th>입사일</th>
				<td>
					<input type="text" class="selector" name="hire_date_start">
					~
					<input type="text" class="selector" name="hire_date_end">
				</td>
			</tr>
		</table>
